 ...
 *
 * @generatedBy CodePro at 5/13/18 8:50 PM
 * @author Marcus
...
public class FreeColDirectoriesTest {
	...
	public void testGetBaseClientOptionsFile_1()
		...
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\base\\client-options.xml", result.getCanonicalPath());
		...
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\base\\client-options.xml", result.getAbsolutePath());
	...
	public void testGetBaseDirectory_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\base", result.getCanonicalPath());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\base", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
	...
	public void testGetDataDirectory_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data", result.getCanonicalPath());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
	...
	public void testGetHighScoreFile_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\HighScores.xml", result.getCanonicalPath());
		assertEquals(null, result.getParent());
		assertEquals(false, result.isAbsolute());
		assertEquals(null, result.list());
		assertEquals(false, result.canExecute());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\HighScores.xml", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
		assertEquals(null, result.getParentFile());
	...
	public void testGetI18nDirectory_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\strings", result.getCanonicalPath());
		assertEquals("data", result.getParent());
		assertEquals(false, result.isAbsolute());
		assertEquals(null, result.list());
		assertEquals(false, result.canExecute());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\strings", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
	...
	public void testGetMapsDirectory_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\maps", result.getCanonicalPath());
		assertEquals("data", result.getParent());
		assertEquals(false, result.isAbsolute());
		assertEquals(null, result.list());
		assertEquals(false, result.canExecute());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\maps", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
	...
	public void testGetRulesClassicDirectory_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\rules\\classic", result.getCanonicalPath());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\rules\\classic", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
	...
	public void testGetRulesDirectory_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\rules", result.getCanonicalPath());
		assertEquals("data", result.getParent());
		assertEquals(false, result.isAbsolute());
		assertEquals(null, result.list());
		assertEquals(false, result.canExecute());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\rules", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
	...
	public void testGetStandardModsDirectory_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\mods", result.getCanonicalPath());
		assertEquals("data", result.getParent());
		assertEquals(false, result.isAbsolute());
		assertEquals(null, result.list());
		assertEquals(false, result.canExecute());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\data\\mods", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
	...
	public void testGetStartMapFile_1()
		...
		assertEquals(0L, result.length());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\startMap.fsg", result.getCanonicalPath());
		assertEquals(null, result.getParent());
		assertEquals(false, result.isAbsolute());
		assertEquals(null, result.list());
		assertEquals(false, result.canExecute());
		...
		assertEquals(false, result.canWrite());
		assertEquals(false, result.exists());
		assertEquals("C:\\Users\\Marcus\\Downloads\\eclipse-java-oxygen-2-win32-x86_64\\eclipse\\startMap.fsg", result.getAbsolutePath());
		assertEquals(0L, result.getFreeSpace());
		assertEquals(null, result.getParentFile());
