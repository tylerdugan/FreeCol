...
public class BuildingPanel extends MigPanel implements PropertyChangeListener {
    ...
    public void update() {
        ...
        if (info != null && !info.getProduction().isEmpty()) {
            ...
            if (output.getAmount() > 0) {
                output = buildingAbility(colony, output);
	...
	public void prodOutput(ProductionLabel productionOutput) {
		JLabel upkeep = null;
	...
	public AbstractGoods buildingAbility(final Colony colony, AbstractGoods output) {
